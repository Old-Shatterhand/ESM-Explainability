...
from ESM_explainability.modules.BERT.BERT import BertModel
...
class BertClassifier(nn.Module):
    ...
    def __init__(self,
        ...
        bert = ESMForSequenceClassification.from_pretrained(bert_dir, num_labels=num_labels)
...
if __name__ == '__main__':
    ...
    model = ESMForSequenceClassification.from_pretrained('bert-base-uncased', num_labels=2)
